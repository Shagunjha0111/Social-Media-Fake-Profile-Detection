...
def read_train_model():
    ...
    fake_users = pd.read_csv("datafake.csv")
    genuine_users = pd.read_csv("datareal.csv")
...
def main():
    ...
    df = pd.read_csv('datareal.csv')  # Replace 'datareal.csv' with the actual filename

    # Define the required columns for input
    input_columns = ['statuses_count', 'followers_count', 'friends_count', 'favourites_count', 'listed_count', 'lang']
